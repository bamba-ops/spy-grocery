...
<template>
  <div>
      ...
      <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 class="font-['Cormorant_Garamond'] text-4xl font-semibold italic tracking-tight sm:text-5xl">
            {{ activeQuery }}
          </h1>
        </div>
      ...
      <div v-if="isLoading" class="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <div v-else class="mt-6">
      ...
      <div class="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <div class="mt-4 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            <p class="font-['Cormorant_Garamond'] text-2xl font-semibold italic">
          ...
          <div class="text-right">
            ...
            <p class="font-['Cormorant_Garamond'] text-4xl font-semibold italic">
 ...
 -->
      ...
      <div class="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          <div class="relative">
            <div class="absolute left-4 top-4 rounded-full border border-white/20 bg-black/80 px-3 py-1 text-[10px] uppercase tracking-[0.3em] text-white/80">
              Lowest price
            </div>
            <div class="aspect-square rounded-t-2xl border-b border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-white/10">
              <img
                ...
                loading="lazy"
              />
              <div v-else class="flex h-full w-full items-center justify-center text-5xl text-white/60">
          ...
          <div class="flex flex-1 flex-col p-5">
            ...
            <h3 class="mt-2 font-['Cormorant_Garamond'] text-2xl font-semibold italic">
              {{ product.name }}
            </h3>
            ...
            <div class="mt-6 flex items-center justify-between">
              <span class="font-['Cormorant_Garamond'] text-3xl font-semibold italic">
