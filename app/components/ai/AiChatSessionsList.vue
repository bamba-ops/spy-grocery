...
<template>
  <section class="flex h-full flex-col px-5 py-4 sm:px-6">
    <div class="mb-3 flex items-center justify-between gap-3">
      <p class="text-[10px] uppercase tracking-[0.35em] text-white/55">Conversations recentes</p>
    ...
    <p v-if="isHydrating" class="mb-2 text-[10px] uppercase tracking-[0.3em] text-white/60">Ouverture de la conversation...</p>
    ...
    >
      Aucune conversation pour le moment. Commencez avec "Nouveau chat".
    </p>
